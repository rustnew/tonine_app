...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_ba74e3369f9f4cb0 = function(arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 462, function: Function { arguments: [Ref(NamedExternref("Event"))], shim_idx: 463, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
        const ret = makeClosure(arg0, arg1, 462, __wbg_adapter_9);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('yew_course_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
